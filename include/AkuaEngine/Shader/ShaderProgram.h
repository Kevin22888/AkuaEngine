#ifndef AKUAENGINE_SHADER_PROGRAM_H
#define AKUAENGINE_SHADER_PROGRAM_H
...
void ShaderProgram::setUniform(const std::string& name, const T& value) {
    ...
    if constexpr (std::is_same_v<T, float>) {
        ...
        static_assert(AlwaysFalse<T>::value, "[AkuaEngine::ShaderProgram::setUniform] Unsupported uniform type T.");
    }
}

} // namespace AkuaEngine

#endif // AKUAENGINE_SHADER_PROGRAM_H